...
#[derive(Clone)]
pub struct GenericCopyIntoTablePlan<QueryPlan> {
...
impl<QueryPlan> GenericCopyIntoTablePlan<QueryPlan> {
...
impl<QueryPlan: Debug> Debug for GenericCopyIntoTablePlan<QueryPlan> {
    fn fmt(&self, f: &mut Formatter) -> std::fmt::Result {
        let GenericCopyIntoTablePlan {
            catalog_info,
            database_name,
            table_name,
            no_file_to_copy,
